...
// A red Toast is shown at the top when encounting any error.
...
export default function AuthenticationPage() {
  ...
  async function handleSignUp() {
    ...
    clearForm();
    setIsSignUp(false); // send them to the Sign in form after finishing Sign up
  ...
  return (
    ...
    >
      ...
      >
        {loading ? (
          <ActivityIndicator color="white" /> // ActivityIndicator shows when loading
        ) : (
